...
manuallyDefinePump(UA_Server *server) {
    ...
    oAttr.displayName = UA_LOCALIZEDTEXT("en-US", "Fan1 (Manual)");
    UA_Server_addObjectNode(server, UA_NODEID_NULL,
                            UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                            UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES),
                            UA_QUALIFIEDNAME(1, "Fan1 (Manual)"), UA_NODEID_NUMERIC(0, UA_NS0ID_BASEOBJECTTYPE),
                            oAttr, NULL, &pumpId);

    UA_VariableAttributes mnAttr = UA_VariableAttributes_default;
    UA_String manufacturerName = UA_STRING("Microchip");
    UA_Variant_setScalar(&mnAttr.value, &manufacturerName, &UA_TYPES[UA_TYPES_STRING]);
    mnAttr.displayName = UA_LOCALIZEDTEXT("en-US", "Microchip");
    UA_Server_addVariableNode(server, UA_NODEID_NULL, pumpId,
                              UA_NODEID_NUMERIC(0, UA_NS0ID_HASCOMPONENT),
                              UA_QUALIFIEDNAME(1, "Microchip"),
                              UA_NODEID_NUMERIC(0, UA_NS0ID_BASEDATAVARIABLETYPE), mnAttr, NULL, NULL);

    UA_VariableAttributes modelAttr = UA_VariableAttributes_default;
    UA_String modelName = UA_STRING("EMC2305 Fan1 ");
    UA_Variant_setScalar(&modelAttr.value, &modelName, &UA_TYPES[UA_TYPES_STRING]);
    modelAttr.displayName = UA_LOCALIZEDTEXT("en-US", "EMC2305");
    UA_Server_addVariableNode(server, UA_NODEID_NULL, pumpId,
                              UA_NODEID_NUMERIC(0, UA_NS0ID_HASCOMPONENT),
                              UA_QUALIFIEDNAME(1, "EMC2305"),
    ...
    rpmAttr.displayName = UA_LOCALIZEDTEXT("en-US", "FanRPM");
    UA_Server_addVariableNode(server, UA_NODEID_NULL, pumpId,
                              UA_NODEID_NUMERIC(0, UA_NS0ID_HASCOMPONENT),
                              UA_QUALIFIEDNAME(1, "FanRPMs"),
...
defineObjectTypes(UA_Server *server) {
    ...
    dtAttr.displayName = UA_LOCALIZEDTEXT("en-US", "EMC2305_Fan_controller");
    ...
    ptAttr.displayName = UA_LOCALIZEDTEXT("en-US", "Fan controller");
    UA_Server_addObjectTypeNode(server, pumpTypeId,
                                deviceTypeId, UA_NODEID_NUMERIC(0, UA_NS0ID_HASSUBTYPE),
                                UA_QUALIFIEDNAME(1, "Fan controller"), ptAttr,
                                NULL, NULL);
...
pumpTypeConstructor(UA_Server *server,
    ...
    UA_LOG_INFO(UA_Log_Stdout, UA_LOGCATEGORY_USERLAND, "A New Fan controller EMC2305 created");
...
int main(void) {
    ...
    addPumpObjectInstance(server, "Fan2");
    addPumpObjectInstance(server, "Fan3");
    addPumpTypeConstructor(server);
    addPumpObjectInstance(server, "Fan4");
    addPumpObjectInstance(server, "Fan5");
